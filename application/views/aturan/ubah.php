<form method="post" action="">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="insentif" placeholder="Insentif (tanpa tanda titik atau koma)" name="insentif" value="<?=$data->insentif;?>">
      <?=form_error('insentif');?>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bonus" placeholder="Bonus (tanpa tanda titik atau koma)" name="bonus"  value="<?=$data->bonus;?>">
      <?=form_error('bonus');?>
    </div>
  </div>
  <div class="form-group row">
