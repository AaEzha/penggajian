<form action="" method="post">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="nama" placeholder="Nama Karyawan" name="nama" value="<?=$data->nama;?>">
      <?=form_error('nama');?>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="datepicker" placeholder="Tanggal Lahir" name="tgl_lahir" value="<?=$data->tgl_lahir;?>">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="telp" placeholder="No.Telepon" name="telp" value="<?=$data->telp;?>">
      <?=form_error('telp');?>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="masakerja" placeholder="Masa Kerja" name="masakerja" value="<?=$data->masakerja;?>">
