<form action="" method="post">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <select name="idkaryawan" id="inputIdkaryawan" class="form-control select2">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="datepicker" placeholder="Tanggal Penerimaan" name="tanggal" value="<?=date('Y-m-d');?>">
      <?=form_error('tanggal');?>
    </div>
  </div>
  <div class="form-group row">
